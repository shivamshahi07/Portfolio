...
const AboutMe = () => {
  return (
    <main className="" id="about-me">
      <h1 className=" w-full flex flex-col gap-y-2 items-center justify-center px-4 md:px-36 lg:px-48 mt-12 scroll-mt-20 text-3xl md:text-4xl font-semibold mb-3 md:mb-4">
        About Me🧑🏻‍🔧
      </h1>
      <div className="flex">
