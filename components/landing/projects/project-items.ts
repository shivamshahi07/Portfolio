...
export const projectitems = [
  {
    ...
    skills: ["Typescript", "Tailwind CSS", "Next Js", "Prisma","Zod", "MongoDB","Daisy UI"],
  },
  {
    id: 2,
    ...
    skills: ["Typescript", "Tailwind CSS", "Next Js","Framer Motion","Shadcn UI","radix"],
  },
  {
    id: 3,
    ...
    skills: ["React", "Next.js", "MongoDB", "Tailwind CSS", "Framer Motion","Resend(Email)","Typescript","Shadcn UI"],
  },
  // {
  //   id: 4,
  //   name: "project-name",
